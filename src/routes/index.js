...
router.post('/playlist/:playlistId', ensureSpotifyAuthentication, asyncHandler(index.addPlaylist))
router.get('/playlist', ensureSpotifyAuthentication, asyncHandler(index.getManagedPlaylistsIds))
router.delete('/playlist/:playlistId', ensureSpotifyAuthentication, asyncHandler(index.removePlaylist))
router.get('/me/playlist', ensureSpotifyAuthentication, asyncHandler(index.getMyPlaylists))
router.post('/trigger-reorder', ensureSpotifyAuthentication, asyncHandler(index.triggerReorder))
